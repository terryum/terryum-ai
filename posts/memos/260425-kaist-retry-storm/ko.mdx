...
> 이전 글 [조용한 청구서 - Bot에도 과금하는 Vercel](/ko/posts/260419-vercel-quiet-bill) 이 "왜 청구서가 부풀었나(구조 문제)"를 다뤘다면, 이 글은 "그날 정확히 무엇이 일어났고 내 책임은 무엇이었나(개별 사건의 복기)"를 다룬다.
...
- [조용한 청구서 - Bot에도 과금하는 Vercel](/ko/posts/260419-vercel-quiet-bill) — 같은 사고를 비용 구조 관점에서 다룬 글. 이 글이 "사건"이라면 그 글은 "구조".
